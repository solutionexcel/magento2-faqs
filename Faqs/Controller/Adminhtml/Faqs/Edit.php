...
class Edit extends \Solutionexcel\Faqs\Controller\Adminhtml\Faqs
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('solutionexcel_faqs_faqs', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Faqs'));
        return $resultPage;
    }
}
